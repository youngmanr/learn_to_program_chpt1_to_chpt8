...
while bottles != 0
  ...
  puts english_number_bottles_s + " bottles of beer on the wall, " + english_number_bottles_s + " bottles of beer."
  bottles -= 1
  if bottles != 0
    english_number_bottles_s = englishNumber(bottles).to_s
    puts "Take one down and pass it around, " + english_number_bottles_s + " bottles of beer on the wall."
  else
